...
export const Services: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="Complete Interior Design Services in Hyderabad | Bright Liv"
        description="Discover complete interior design services in Hyderabad by Bright Liv. We create stylish home, apartment, villa, office, and commercial interiors with turnkey solutions."
        keywords="interior design services Hyderabad, false ceiling design, modular woodwork, wall cladding, luxury furniture, home theater installation, swimming pool design, B2B interior solutions"
        canonical="/services"
        image={OG_IMAGE}
      />
      <Helmet>
      ...
      <main className="w-full min-h-screen bg-[#FAF9F6] text-[#704f62] overflow-hidden font-sans pb-32">
        <h1 className="sr-only">
          Complete Interior Design Solutions in Hyderabad
        </h1>
        {/* 1. HEADER SECTION */}
